  ...
  data () {
    return {
      questions: [
        ...
        {'Company': 'Uber', 'Category': 'Business', 'Question': "What metrics would you use to track whether Uber's strategy of using paid advertising to acquire customers works? How would you then figure out an acceptable cost of customer acquisition?", 'Color': 'black black--text'},
